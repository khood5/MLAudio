...
python ../data/makeBackgroundAudio.py -l 2 -sr 12000 data/raw_backgrounds_index.py 100 data/genBackgrounds
python make_index.py -d data/genBackgrounds/ -o data/backgrounds_index.csv

python ../data/makeGunshotAudio.py -n 100 -sr 12000 data/backgrounds_index.csv data/raw_gunshots_index.py data/gunshots
