...
parser.add_argument('--train_out', default='neuroTrain.npy', type=str, help='Path to the train output file')
parser.add_argument('--valid_out', default='neuroValid.npy', type=str, help='Path to the valid output file')
parser.add_argument('--test_out', default='neuroTest.npy', type=str, help='Path to the test output file')
